...
//actualiza la cantidad del carrito, dentro de la etiqueta "tr" busca a cantidad
    $("tr #Cant").click(function (e) {
        var idp = $(this).parent().find('#item1').val();//busca a item.1 dentro de carrito.jsp
        var cantidad = $(this).parent().find('#Cant').val();//#Cant es el valor de la caja de texto
