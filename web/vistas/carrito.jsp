...
<%@page import="com.easybuy.config.Fecha"%>
...
<html>
    ...
    <body>       
        ...
        <div class="container mt-4">
            <div class="d-flex text-info text-center">
                <div id="tituloCa" >
                <h2>Carrito</h2> 
                </div>
                <%
                ...
                %>                     
                <p class="fecha ml-auto border-info"><%= fechaSistema.Fecha()%></p>                               
            </div>                    
            <div class="row">             
                <div class="col-lg-9 ">                 
                ...
                <div class="col-lg-3">                  
                    <div class="card">
                        <div class="generar card-header text-warning text-center">
                            Generar Compra
                        </div>
                        <div class="generar2 card-body text-warning">
                            <label>Subtotal:</label>
                            <a class="form-control text-center text-info"><i class="fas fa-dollar-sign h5"> ${totalPagar}0</i></a>
                            <label>Precio Envio:</label>
                            <a class="form-control text-center text-info"><i class="fas fa-dollar-sign h5"> 0.00</i></a>
                            <label>Descuento:</label>
                            <a class="form-control text-center text-info"><i class="fas fa-dollar-sign h5"> 0.00</i></a>
                            <label>Total a Pagar:</label>
                            <a class="form-control text-center text-info"><i class="fas fa-dollar-sign h4 primary"> ${totalPagar}0</i></a>
                        </div>
                        <div class="card-footer">
                            <a href="Controlador?accion=GenerarCompra" class="btn btn-success btn-block"><img src="img/check.png" alt="20" height="20" class="rounded-circle">Generar Compra</a>
                            <a href="#" data-toggle="modal" data-target="#myModalPago" class="btn btn-info btn-block"><img src="img/tarjeta.png" alt="20" height="20" class="rounded-circle">Realizar Pago</a>
                        </div>
                    </div>
                </div>
            </div>          
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        ...
                                        <button type="submit" name="accion" value="Registrar" class="btn btn-info btn-block">Crear Cuenta</button>
                                    </form>
                                </div>                          
                            </div> 
                        </div>
        ...
        <div class="modal fade" id="myModalPago" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">         
                <div class="modal-content ">                   
                    <div class="pago modal-header text-center text-info bg-warning "> 
                        <label><i class=""></i><img src="img/tarjeta.png" alt="20" height="20" class="rounded-circle">Realizar Pago</label>
                        <button type="button" class="close" data-dismiss="modal">
                            <span aria-hidden="true">&times;</span>
                        </button>  
                    </div>
                    <div class="modal-body"> 
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-iniciar" role="tabpanel">
                                <form action="Controlador">
                                    <div class="pago1 form-group text-info">
                                    ...
                                    <div class="pago1 form-group text-info">
                                        <label>Monto</label>
                                        <input disabled="" type="text" name="txtmonto" value="$.${totalPagar}0" class="form-control h1">
                                    </div>                                   
