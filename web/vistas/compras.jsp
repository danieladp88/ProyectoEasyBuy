...
<html>
    ...
    <body>       
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <ul class="navbar-nav btn-group my-2 my-lg-0" role="group">
                    <a style="color: white; cursor: pointer" class="dropdown-toggle text-info" data-toggle="dropdown">
                        <i class=""></i><img src="img/usuario2.png" alt="20" height="20" class="rounded-circle"/> ${logueo}</a>
        ...
        <div class="container mt-4 text-info text-center">
            <div id="tituloCo">
            <h2>Mis Compras</h2>
            </div>
            <div class="row">            
                <table class="table tab-pane bg-info">
                    <thead class="thead-light">
                        <tr class="text-center ">
                            <th >Codigo<br>de<br> Compra</th>                               
                            <th>Fecha<br> de<br> Compra</th>
                            <th>Total<br>a<br>Pagar</th>                                                   
                            <th>Codigo<br> de<br> Pago</th>                                                   
                            <th>Estado</th>                                                   
                            <th></th>                                                   
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="p" items="${myCompras}">
                            <tr class="text-center">
                                ...
                                <td>${p.getEstado()}</td>                                                                                                       
                                <td>
                                    <a class="bg-warning text-white" href="Controlador?accion=verDetalle&idcompra=${p.getId()}">Ver Detalle</a>
                                </td>                                                                                                       
                            </tr>
                        </c:forEach>
                    </tbody>
